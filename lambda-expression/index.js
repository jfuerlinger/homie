...
function getWelcomeResponse(callback) {
    ...
    const speechOutput = 'Willkommen zu meinem ersten Alexa Skill. ' +
        'Bitte gib Bescheid, welche Aktion du durchführen möchtest:';
...
function handleSessionEndRequest(callback) {
    const cardTitle = 'Session beendet';
    const speechOutput = 'Danke, dass du meinen ersten Alexa Skill verwendet hast. Ich wünsche dir noch einen schönen Tag!';
...
function onIntent(intentRequest, session, callback) {
    ...
    if (intentName === 'AMAZON.HelpIntent') {
        ...
        if (err) {
			...
			const cardTitle = 'Aktion durchgeführt';
			const speechOutput = 'Das Licht wurde eingeschaltet!';
			const shouldEndSession = false;
			callback({}, buildSpeechletResponse(cardTitle, speechOutput, null, shouldEndSession));
		} });
    }
